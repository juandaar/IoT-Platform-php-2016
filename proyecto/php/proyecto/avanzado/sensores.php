			...
			<li class="treeview">
			 ...
			 <li class="active">
              ...
              <ul class="treeview-menu">
                     ...
                     <li class="active"><a href="#"><i class="fa  fa-flash"></i>Sensores</a></li>
...
$transmitir['contenido']=' <!-- Content Header (Page header) -->
	...
	<div class="row">
			  ...
			  <div class="box box-success" >
               ...
               <h3 class="box-title">Creación nuevos sensores</h3>
               </div>
			...
			<form class="form-horizontal">
                      ...
                      <div class="col-sm-8">
                        <input type="descripción" class="form-control" id="descripcion_sensor" placeholder="   Información relevante del sensor">
                      </div>
				     </div>
				    ...
				    <div class="form-group">
					  <label class="col-sm-2 control-label">Dispositivo</label>
						<div class="col-sm-8">
                      <select class="form-control select2" data-placeholder="Seleccione el dispositivo" style="width: 100%;" id="clase_dispositivos" >
